...
enum CELL_TYPE{
    ...
    QuestionBlock0,
    QuestionBlock0M,
    PIPE_FIRST, // 2024-12-02 TJG: Added PIPE_FIRST for teleportation logic
    PIPE_LAST,   // 2024-12-02 TJG: Added PIPE_LAST for teleportation logic
     Koopa, //MEC 11/27/2024 - Adds Koopa into the cell_type to be able to use on mapmanager.cpp
    KingGoomba, /*2024-12-2 MHS: initiates king goomba as cell type*/
    Bowser, /*2024-12-6 MHS: declare bowser as a cell type*/
    Hammer /*2024-12-08 TJG: initiates hammer as cell type*/
};
...
static QString cellTypeToString(CELL_TYPE t)
{
    ...
    else if (t == PIPE_FIRST) // 2024-12-02 TJG: Added PIPE_FIRST case
    {
        return QString("Pipe First");
    }
    else if (t == PIPE_LAST) // 2024-12-02 TJG: Added PIPE_LAST case
    {
        return QString("Pipe Last");
    }
    else
    {
...
static constexpr const int E_KEY           = 12;
static constexpr const int SHIFT_KEY       = 13; //MEC| adding shift key


static constexpr const int COUNT_OF_KEYS   = 14;  //increment by one
...
static const QMap<int, int> KeysMapper =
{
    ...
    {static_cast<int>(Qt::Key_E),     E_KEY},  //SHIFTKEY
